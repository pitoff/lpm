            ...
            {user.role === 1 &&
                ...
                MENU
                                ...
                                <ul className="mb-6 flex flex-col gap-1.5">
                                        ...
                                        {(handleClick, open) => {
                                            return (
                                                <React.Fragment>
                                                    <NavLink
                                                        to="#"
                                                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/occupants' ||
                                    ...
                                    {/* <!-- Menu Item Property Module --> */}
                                    <SidebarLinkGroup
                                        activeCondition={
                                            pathname === '/properties' || pathname.includes('properties')
                                        }
                                    >
                                        {(handleClick, open) => {
                                            return (
                                                <React.Fragment>
                                                    <NavLink
                                                        to="#"
                                                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/properties' ||
                                    ...
                                    <li>
                                        <NavLink
                                            to="/property-type"
                                            className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('property-type') && 'bg-graydark dark:bg-meta-4'
                                                }`}
                                        >
                                            <svg
                                                className="fill-current"
                                    ...
                                    <button
                                        ...
                                        aria-controls="sidebar"
                                        aria-expanded={sidebarOpen}
                                        // className="block lg:hidden rounded-md text-white bg-primary"
