...
import { ArrowDownLeftIcon, ArrowLeftIcon, InboxArrowDownIcon, PrinterIcon } from '@heroicons/react/24/outline';
import './PrintReceipt.css';
import { useStateContext } from '../../context/ContextProvider';
import { toast } from 'react-toastify';

const RentReceiptPublic = () => {
    const { id } = useParams();
    ...
    const getReceipt = async () => {
        setLoading(true)
        await axiosInstance.get(`/rent-receipt-public/${id}`)
            .then(({ data }) => {
                setLoading(false)
            ...
            {!loading &&
                <div class="grid grid-cols-6 gap-4">
                    <div class="col-start-2 col-span-4">
                        <div className="rounded p-4 shadow bg-white" id='divToPrint'>
                        ...
                        <div className='flex justify-between mt-5'>
                            ...
                            <Link
                                to={`/my-rent-history`}
                                className="inline-flex items-center justify-center rounded-md border border-meta-3 py-2 px-4 text-center font-medium text-meta-3 hover:bg-success hover:text-white lg:px-4 xl:px-4"
...
export default RentReceiptPublic