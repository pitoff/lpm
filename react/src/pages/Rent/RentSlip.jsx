                      ...
                      <tr key={list.id}>
                        ...
                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                          <div className="flex items-center space-x-3.5">                            
                            <Link
                              to={`/rent-receipt/${list.id}`}
                              className="inline-flex items-center justify-center rounded-md bg-primary border border-primary py-2 px-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-2 xl:px-2"
                            >
